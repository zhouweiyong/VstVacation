<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\www\VstVacation\public/../application/admin\view\index\index.html";i:1480070138;s:63:"D:\www\VstVacation\public/../application/admin\view\layout.html";i:1480070253;s:68:"D:\www\VstVacation\public/../application/admin\view\public\menu.html";i:1479200138;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="main-container" id="main-container">
    ...
    <div class="margin-b10">
        <form class="form-inline" action="<?php echo url('Index/index'); ?>" method="post">
            <div class="form-group">
                <label for="realName" class="control-label">姓名：</label>
                <input type="text" id="realName" name="realName" class="input-sm form-control"/>
            </div>
            <button class="btn btn-info btn-sm" id="query"><i class="icon-search "></i>查询</button>
            <div class="form-group pull-right ">
                <a href="<?php echo url('User/add'); ?>" class="btn btn-sm btn-primary" id="addbtn">新增</a>
                <a href="#" class="btn btn-sm btn-danger"><i class="icon-refresh"></i>刷新</a>
            </div>
        </form>
    </div>
        ...
        <div>
            <table class="table table-striped table-bordered table-hover bg-white">
                ...
                <tr>
                    ...
                    <td><?php echo date('Y/m/d H:i',$user['lastTime']); ?></td>
                    <td>
                        <a href="<?php echo url('User/edit'); ?>?userId=<?php echo $user['id']; ?>" class="btn btn-primary btn-xs">编辑</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
