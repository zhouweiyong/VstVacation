<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\VstVacation\public/../application/admin\view\user\add.html";i:1480313904;s:63:"D:\www\VstVacation\public/../application/admin\view\layout.html";i:1480070253;s:68:"D:\www\VstVacation\public/../application/admin\view\public\menu.html";i:1479200138;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="main-container" id="main-container">
    ...
    <?php if(is_array($Config['menu']) || $Config['menu'] instanceof \think\Collection): $i = 0; $__LIST__ = $Config['menu'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;if(isset($menu['control_sub'])): ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content"><div class="col-xs-12">
    <form action="<?php echo url('User/createUser'); ?>" method="post" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="realName" id="realName" class="col-xs-10 col-sm-5"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="phoneNum" id="phoneNum" class="col-xs-10 col-sm-5"/>
            </div>
        </div>
        <div class="form-group center-block">
            <div class="col-sm-offset-4 col-xs-offset-3">
            <button class="btn btn-primary col-sm-2" type="submit">添加用户</button>
            </div>
        </div>
    </form>
